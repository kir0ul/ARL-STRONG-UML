...
const cueMessages = [
  "I decided to keep the score for myself.",
  "I decided to keep the score for myself.",
  "I decided to keep the score for myself.",
  "I decided to keep the score for myself.",
  "I decided to keep the score for myself.",
...
function startMatching() {
  ...
  $("#matching-modal")[0].style.setProperty(
    "height",
    "max-content",
    "important",
  );
  ...
  $("#matching-content").on("click", (e) => {
    $("#matching-content").html(
      `<span style="display:block;">Your teammate says:</span>Let's work as a team and maximize our team score!`,
    );
    document
      .querySelector(":root")
      .style.setProperty("--envelope-scale-y", "-1");
    document
      .querySelector(":root")
      .style.setProperty("--envelope-translate-y", "100%");
    $(e.target).css({
      padding: "3rem 1rem",
    });
...
function showCueMessage() {
  if (intervalCount < intervals) {
    ...
    $("#matching-content").html(
      `<span style="display:block;">Your teammate says:</span>${cueMessages[intervalCount - 1]}`,
    );
