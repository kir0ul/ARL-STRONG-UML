...
!(function (a, b, c) {
  ...
  function (a, b) {
    ...
    function l(a, b) {
      0 === b.savedTransforms.length
        ? (b.transforms = j(Fa))
        : (a.restore(), (b.transforms = b.savedTransforms.pop()));
    }
    function m(a, b, c, d) {
    ...
    function o(a, b, c) {
      c.mask &&
        (c.autosave && k(a, b), a.clip(), b.transforms.masks.push(c._args));
    }
    function p(a, b) {
    ...
    function t(a, b, c) {
      var d;
      for (d in Ia.events)
        Object.prototype.hasOwnProperty.call(Ia.events, d) &&
          (c[d] || (c.cursors && c.cursors[d])) &&
          v(a, b, c, d);
      b.events.mouseout ||
        (a.bind("mouseout.jCanvas", function () {
          var c,
            d = b.drag.layer;
          for (
            d && ((b.drag = {}), G(a, b, d, "dragcancel")), c = 0;
            c < b.layers.length;
            c += 1
          )
            ((d = b.layers[c]),
    ...
    function v(a, b, c, d) {
      (u(a, b, c, d),
        ("mouseover" !== d && "mouseout" !== d && "mousemove" !== d) ||
          (b.redrawOnMousemove = !0));
    }
    function w(a, b, c) {
      var d, e, f;
      if (c.draggable || c.cursors) {
        for (
          d = ["mousedown", "mousemove", "mouseup"], f = 0;
          f < d.length;
          f += 1
        )
          ((e = d[f]), u(a, b, c, e));
    ...
    function A(a, b, c, d) {
      c &&
        c.visible &&
        c._method &&
        ((c._next = d || null), c._method && c._method.call(a, c));
    }
    function B(a, b, c) {
      ...
      if (
        ...
        if (
          (g.dragging ||
            ((g.dragging = !0),
            (e.dragging = !0),
            e.bringToFront && (d.splice(e.index, 1), (e.index = d.push(e))),
            (e._startX = e.x),
            (e._startY = e.y),
            (e._endX = e._eventX),
            (e._endY = e._eventY),
          ...
          for (
            ...
            if (((j = h[k]), (i = b.layer.groups[j]), e.groups && i))
              for (f = 0; f < i.length; f += 1)
                i[f] !== e &&
                  ("y" !== e.restrictDragToAxis &&
                    "y" !== i[f].restrictDragToAxis &&
                    (i[f].x += e.dx),
                  "x" !== e.restrictDragToAxis &&
                    "x" !== i[f].restrictDragToAxis &&
                    (i[f].y += e.dy));
      } else
        ("mouseup" !== c && "touchend" !== c) ||
          (g.dragging &&
            ((e.dragging = !1),
            (g.dragging = !1),
    ...
    function E(a, b, c, d, e) {
      d[c] &&
        b._running &&
        !b._running[c] &&
        ((b._running[c] = !0), d[c].call(a[0], b, e), (b._running[c] = !1));
    }
    function F(b, c) {
      ...
      return (
        ...
        d._method ||
          (g
            ? (d._method = g)
            : d.method
              ? (d._method = a.fn[d.method])
              : d.type && (d._method = a.fn[Da.drawings[d.type]])),
        d.layer && !d._layer
          ? ((h = a(b)),
            (j = s(b)),
            (k = j.layers),
            (null === l.name ||
              (e(l.name) && void 0 === j.layer.names[l.name])) &&
              (i(d),
              (l = new c(d)),
              (l.canvas = b),
              (l.layer = !0),
    ...
    function J(a, b) {
      ...
      for (d = 0; d < Ga.props.length; d += 1)
        ((c = Ga.props[d]),
          void 0 !== a[c] &&
            ((a["_" + c] = a[c]), (Ga.propsObj[c] = !0), b && delete a[c]));
    }
    function K(a, b, c) {
      var d, e, g, h;
      for (d in c)
    ...
    function N(a) {
      var b,
        c = 3;
      for (
        "array" !== ta(a.start) && ((a.start = M(a.start)), (a.end = M(a.end))),
          a.now = [],
      ...
      (1 !== a.start[3] || 1 !== a.end[3]
        ? (a.now = "rgba(" + a.now.join(",") + ")")
        : (a.now.slice(0, 3), (a.now = "rgb(" + a.now.join(",") + ")")),
        a.elem.nodeName
          ? (a.elem.style[a.prop] = a.now)
          : (a.elem[a.prop] = a.now));
    }
    function O(a) {
    ...
    function R(a, b, c) {
      ...
      (d = c._args) &&
        ...
        null !== f.x &&
          ...
          (g =
            b.isPointInPath(i, j) ||
            (b.isPointInStroke && b.isPointInStroke(i, j)))),
        (h = e.transforms),
        (d.eventX = f.x),
        (d.eventY = f.y),
        (d.event = f.event),
        ...
        (j = d.eventY),
        0 !== k
          ? ((d._eventX = i * za(-k) - j * ya(-k)),
            (d._eventY = j * za(-k) + i * ya(-k)))
          : ((d._eventX = i), (d._eventY = j)),
        (d._eventX /= h.scaleX),
        (d._eventY /= h.scaleY),
    ...
    function $(a, b, c, d, e, f, g, h) {
      (d._arrowAngleConverted ||
        ((d.arrowAngle *= c._toRad), (d._arrowAngleConverted = !0)),
    ...
    function ha(b, c, d, e) {
      ...
      if (
        i.text === d.text &&
        i.fontStyle === d.fontStyle &&
        i.fontSize === d.fontSize &&
        i.fontFamily === d.fontFamily &&
        i.maxWidth === d.maxWidth &&
        i.lineHeight === d.lineHeight
      )
    ...
    ((d.baseDefaults = {
      ...
      (a.fn.getEventHooks = function () {
        var a,
          ...
          d = {};
        return (
          0 !== c.length && ((a = c[0]), (b = s(a)), (d = b.eventHooks)),
          d
        );
      }),
      ...
      (a.fn.getLayer = function (a) {
        ...
        if (0 !== i.length)
          if (
            ((b = i[0]), (c = s(b)), (d = c.layers), (h = ta(a)), a && a.layer)
          )
            f = a;
      ...
      (a.fn.removeLayers = function (b) {
        ...
        for (d = 0; d < i.length; d += 1) {
          for (
            c = a(i[d]), e = s(i[d]), f = c.getLayers(b).slice(0), h = 0;
            h < f.length;
            h += 1
          )
      ...
      (a.fn.addLayerToGroup = function (b, c) {
        ...
        for (e = 0; e < g.length; e += 1)
          ((d = a(g[e])),
            (f = d.getLayer(b)),
            f.groups &&
              ((h = f.groups.slice(0)), -1 === sa(c, f.groups) && h.push(c)),
            d.setLayer(f, { groups: h }));
        return g;
      }),
      ...
      (a.fn.drawLayers = function (b) {
        ...
        for (l = t.index, l || (l = 0), d = 0; d < r.length; d += 1)
          if (((c = a(r[d])), (e = h(r[d])))) {
            ...
            ((m = k),
              t.complete &&
                (t.complete.call(r[d]), delete n.drawLayersComplete),
              (g = z(n)),
              (o = n.event),
              (p = o.type),
              ...
              g &&
                ...
                g._event &&
                  g.intersects &&
                  ((n.lastIntersected = g),
                  (g.mouseover || g.mouseout || g.cursors) &&
                    !n.drag.dragging &&
                    (g._hovered ||
                      g._fired ||
                      ((g._fired = !0),
      ...
      (a.fn.animateLayer = function () {
        ...
        for (
          "object" === ta(j[2])
            ? (j.splice(2, 0, j[2].duration || null),
              j.splice(3, 0, j[3].easing || null),
              j.splice(4, 0, j[4].complete || null),
              j.splice(5, 0, j[5].step || null))
            : (void 0 === j[2]
                ? (j.splice(2, 0, null),
                  j.splice(3, 0, null),
                  j.splice(4, 0, null))
                : f(j[2]) && (j.splice(2, 0, null), j.splice(3, 0, null)),
              void 0 === j[3]
                ? ((j[3] = null), j.splice(4, 0, null))
                : f(j[3]) && j.splice(3, 0, null)),
            c = 0;
          c < i.length;
          c += 1
        )
      ...
      (a.fn.delayLayer = function (b, c) {
        ...
        for (c = c || 0, e = 0; e < h.length; e += 1)
          ((d = a(h[e])),
            (f = s(h[e])),
            (g = d.getLayer(b)) && (a(g).delay(c), G(d, f, g, "delay")));
        return h;
      }),
      ...
      (a.fn.stopLayer = function (b, c) {
        ...
        for (e = 0; e < h.length; e += 1)
          ((d = a(h[e])),
            (f = s(h[e])),
            (g = d.getLayer(b)) && (a(g).stop(c), G(d, f, g, "stop")));
        return h;
      }),
      ...
      (a.event.fix = function (b) {
        ...
        if (((b = Ca.call(a.event, b)), (d = b.originalEvent)))
          if (
            ((e = d.changedTouches), void 0 !== b.pageX && void 0 === b.offsetX)
          )
            try {
              ((c = a(b.currentTarget).offset()),
                c &&
                  ((b.offsetX = b.pageX - c.left),
      ...
      (a.fn.saveCanvas = function a(b) {
        ...
        for (d = 0; d < j.length; d += 1)
          if ((e = h(j[d])))
            for (
              g = s(j[d]), f = new c(b), H(j[d], f, b, a), i = 0;
              i < f.count;
              i += 1
            )
              k(e, g);
        ...
        for (d = 0; d < v.length; d += 1)
          if ((e = h(v[d])) && ((f = new c(b)), H(v[d], f, b, a), f.visible)) {
            if (
              ...
              ga(v[d], e, f),
              (i =
                null !== f.maxWidth ? ia(e, f) : f.text.toString().split("\n")),
              ha(v[d], e, f, i),
              ...
              "left" === f.align
                ? f.respectAlign
                  ...
                  : (t -= f.width / 2)
                : "right" === f.align &&
                  (f.respectAlign ? (f.x -= f.width / 2) : (t += f.width / 2)),
              f.radius)
            )
              for (
                l = qa(f.fontSize),
              ...
              for (k = 0; k < i.length; k += 1)
                ((j = i[k]),
                  (u =
                    f.y +
                    (k * f.height) / i.length -
                    ((i.length - 1) * f.height) / i.length / 2),
            ...
            ((u = 0),
              "top" === f.baseline
                ? (u += f.height / 2)
                : "bottom" === f.baseline && (u -= f.height / 2),
              f._event &&
                (e.beginPath(),
                e.rect(
                  f.x - f.width / 2,
      ...
      (a.fn.drawImage = function b(d) {
        function e(a, b, c, d, e) {
          (null === d.width &&
            null === d.sWidth &&
            (d.width = d.sWidth = q.width),
            null === d.height &&
              null === d.sHeight &&
              (d.height = d.sHeight = q.height),
            ...
            null !== d.sy
              ? (null === d.width && (d.width = d.sWidth),
                ...
                d.cropFromCenter &&
                  ((d.sx += d.sWidth / 2), (d.sy += d.sHeight / 2)),
                d.sy - d.sHeight / 2 < 0 && (d.sy = d.sHeight / 2),
                d.sy + d.sHeight / 2 > q.height &&
                  (d.sy = q.height - d.sHeight / 2),
                d.sx - d.sWidth / 2 < 0 && (d.sx = d.sWidth / 2),
                d.sx + d.sWidth / 2 > q.width &&
                  (d.sx = q.width - d.sWidth / 2),
        ...
        function f(b, c, d, f, g) {
          return function () {
            ...
            if (
              ...
              f.layer && ((g._masks = d.transforms.masks.slice(0)), f._next))
            ) {
            ...
            (j = h(v[i])) &&
              ...
              l.visible &&
                ...
                q &&
                  (q.complete || t
                    ? f(g, j, k, l, m)()
                    : ((q.onload = f(g, j, k, l, m)), (q.src = q.src))))));
        return v;
      }),
                ...
                : ((j = l.getContext),
                  l.src || j
                    ...
                    : ((i = new la()),
                      ...
                      (i.src = l)),
                  i.complete || j ? d() : ((i.onload = d), (i.src = i.src))))
            : (k = null),
          k
        );
      }),
        ...
        if (((d = new c(a)), (b = h(n[0])))) {
          for (
            d.x1 = d.x1 || 0,
              ...
              e =
                null !== d.r1 && null !== d.r2
                  ? b.createRadialGradient(d.x1, d.y1, d.r1, d.x2, d.y2, d.r2)
                  : b.createLinearGradient(d.x1, d.y1, d.x2, d.y2),
              j = 1;
            void 0 !== d["c" + j];
            j += 1
          )
      ...
      (a.fn.setPixels = function a(b) {
        ...
        for (e = 0; e < o.length; e += 1)
          if (
            ...
            if (
              ((k = f.getImageData(
                (i.x - i.width / 2) * g.pixelRatio,
                (i.y - i.height / 2) * g.pixelRatio,
                i.width * g.pixelRatio,
                i.height * g.pixelRatio,
              )),
              (l = k.data),
              (n = l.length),
              i.each)
              ...
              for (m = 0; m < n; m += 4)
                ((j = { r: l[m], g: l[m + 1], b: l[m + 2], a: l[m + 3] }),
                  i.each.call(d, j, i),
                  (l[m] = j.r),
                  (l[m + 1] = j.g),
                  (l[m + 2] = j.b),
      ...
      (a.fn.getCanvasImage = function (a, b) {
        ...
        return (
          0 !== d.length &&
            ((c = d[0]),
            c.toDataURL &&
              (void 0 === b && (b = 1), (e = c.toDataURL("image/" + a, b)))),
          e
        );
      }),
